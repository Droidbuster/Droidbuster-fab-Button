...
public class Call_fab_button extends ImageButton{

	public  Call_fab_button (final Context context, AttributeSet attrs) {
		super(context, attrs);
		...
		this.setOnClickListener(new  ImageButton.OnClickListener() {  
            public void onClick(View v)
                  ...
                  try{         	    			
						...
						i.setClassName("com.android.contacts", "com.android.contacts.activities.DialtactsActivity");
