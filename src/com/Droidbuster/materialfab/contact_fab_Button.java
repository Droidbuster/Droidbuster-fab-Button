...
public class contact_fab_Button extends ImageButton{

	public contact_fab_Button(final Context context, AttributeSet attrs) {
		super(context, attrs);
		...
		this.setOnClickListener(new  ImageButton.OnClickListener() {  
            public void onClick(View v)
                  ...
                  try{         	    			
						...
						i.setClassName("com.android.contacts", "com.android.contacts.activities.PeopleActivity");
